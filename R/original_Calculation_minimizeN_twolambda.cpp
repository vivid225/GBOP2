...
// [[Rcpp::export]]
List GetocBiRcpp(int seed, NumericMatrix contrast, NumericVector nobs, double b, double b2, double pow2,
...
//                                double cutstart, double err1, Function ffff)
// {
//   List temp1;
//   List temp2;
//   // int k1=cutstart-1;
...
//         
//         temp1=GetocBiRcpp(seed, contrast, nobs, b_mid1, b_mid2, pow_mid, dprior, pa, pn, ffff);
